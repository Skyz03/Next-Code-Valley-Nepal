...
import FaqSec from "@/components/inner_pages/faq/FaqSec";
import Video from "@/components/inner_pages/faq/Video";
...
export default function Home() {
  return (
    <body className='home-st1 inner-pages-st1 faq-pg-st1'>
      <Cursor />
      <Loader />
      <Menu />
