...
import Banner from "@/components/inner_pages/shop/Banner";
import ProductsSho from "@/components/inner_pages/shop/Products";
import Products from "@/components/inner_pages/shop_det/Products";
import Join from "@/components/inner_pages/faq/Join";
...
export default function Home() {
  return (
    <body className='home-st1 inner-pages-st1 shop-pg-st1'>
      <Cursor />
      <Loader />
      <Menu />
