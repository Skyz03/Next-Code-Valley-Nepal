...
import CasesSec from "@/components/inner_pages/Cases/CasesSec";
import ContactSec from "@/components/inner_pages/contact/ContactSec";
...
export default function Home() {
  return (
    <body className='home-st1 inner-pages-st1 contact-pg-st1'>
      <Cursor />
      <Loader />
      <Menu />
