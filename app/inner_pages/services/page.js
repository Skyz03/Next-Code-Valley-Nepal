...
import ServicesDetSec from "@/components/inner_pages/services_det/ServicesDetSec";
import ServicesSec from "@/components/inner_pages/services/ServicesSec";
import About from "@/components/inner_pages/services/About";
import AboutSer from "@/components/inner_pages/services/About";
import AboutSec from "@/components/inner_pages/about/About";
import Team from "@/components/inner_pages/about/Team";
...
export default function Home() {
  return (
    <body className='home-st1 inner-pages-st1 services-pg-st1'>
      <Cursor />
      <Loader />
      <Menu />
