...
function AboutSec() {
  return (
    <section style={{ zIndex: 7 }} className="tc-pg-about-st1">
      <div style={{ zIndex: 7 }} className="container">
        <div className="row align-items-center justify-content-between">
          <div className="col-lg-5">
            ...
            >
              <img
                src="/inner_pages/assets/img/about.png"
                alt=""
                className="main-img"
              />
            </div>
          ...
          <div className="col-lg-6">
            <div className="info">
              ...
              >
                <li>
                  <img
                    src="/inner_pages/assets/img/icons/success1.png"
                    alt=""
                    className="icon"
                  />
                ...
                <li>
                  <img
                    src="/inner_pages/assets/img/icons/success2.png"
                    alt=""
                    className="icon"
                  />
                  <span className="txt">
